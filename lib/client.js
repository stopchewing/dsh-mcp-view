window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function McpViewPanel(props) {
			...
			return react.createElement(McpViewPanelInner, props);
		}
		...
		function McpViewPanelInner(props) {
			...
			const sessions = typeof props.useSessions === "function" ? props.useSessions() : {};
			const currentSessionId = typeof sessions.current === "string" ? sessions.current : "";
